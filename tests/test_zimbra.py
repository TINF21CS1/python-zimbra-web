...
def test_send_email(zimbra_user: ZimbraUser):
    ...
    response = zimbra_user.send_mail(from_header=f"Python <{zimbra_user.session_data.username}@student.dhbw-mannheim.de>",
                                     to=f"{zimbra_user.session_data.username}@student.dhbw-mannheim.de",
